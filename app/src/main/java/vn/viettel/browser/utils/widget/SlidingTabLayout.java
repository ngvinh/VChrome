...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int[] mDrawableRightTabs;
    ...
    /**
     * Sets icons (drawable) in right of Title tab.
     * number of icons = number of viewPages size()
     *
     * @param mDrawableRightTabs
     */
    public void setDrawableRightTabs(int[] mDrawableRightTabs) {
        this.mDrawableRightTabs = mDrawableRightTabs;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (mDrawableRightTabs != null && i < mDrawableRightTabs.length) {
                tabTitleView.setCompoundDrawablesWithIntrinsicBounds(0, 0, mDrawableRightTabs[i], 0);
            }
